...
def show_startup_banner():
    ...
    banner_block = banner_block_raw + [
         "WannaBeStark RUNS CORD".center(max_w_raw)
    ]
...
def format_log_message(status, message, padding=50):
    ...
    user_tag = f"{grey}~ Wizzed By WannaBeStark {reset}"
...
def switch_config(config_name):
    ...
    if os.name == "nt":
        os.system(
            f'title WannaBeStark ON TOP - Max Concurrent: {__max_concurrent__} - Config: {__current_config_name__}')
...
try:
    ...
    print(
        gradient_text(
            "│ [1] Wizzler        - Standard Mode                          │",
            WIZZLER_START,
            WIZZLER_END,
            bold=True))
    print(
        gradient_text(
            "│ [2] Deadlizer      - Extreme Mode                           │",
            DEADLIZER_START,
            DEADLIZER_END,
            bold=True))
    print(
...
class shakti:
    ...
    async def menu(self):
        while True:
            ...
            if os.name == "nt":
                os.system(f'title WANNABESTARK RUNS CORD')
            ...
            options_raw_1 = """\
    <Made By wannabestark>
    ╭───────────────────────────────────────────────────────────────────────────────────────────────────────────╮
    │                                           WANNABESTARK RUNS CORD                                              │
    ├───────────────────────────────────┬───────────────────────────────────┬───────────────────────────────────┤
...
if __name__ == "__main__":
    try:
        if os.name == "nt":
            os.system(f"title WannaBeStark On Top")
